...
public class Indentifiers {
	...
	public static String generateId() {
		return calculateMd5(tobytes(encodeDate(new Date())));
	}
	
	public static String generateId(String data) {
		return calculateMd5(tobytes(data));
	}
