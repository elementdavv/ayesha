...
public class Trailer extends Base {
    ...
    public void setInfoReference(String value) {
        mInfoReference = value;
    }
	...
	private void renderDictionary() {
		...
		mTrailerDictionary.addNewLine();
        if (mInfoReference != null) {
		    mTrailerDictionary.addContent("  /Info " + mInfoReference);
		    mTrailerDictionary.addNewLine();
        }
